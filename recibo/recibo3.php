...
<body>
    ...
    <div class="recibo">
        ...
        <br><p><b>Decolar Imobiliária LTDA; CNPJ: 49.166.074/0001-91; CRECI 1205-J, Endereço: Rua Vicente Cozza, 137. - ernesto Geisel, João Pessoa - PB, 58075-000, Sala 103. Contato/WhatsApp: (83) 9 8846-0931, Instagram: @DECOLARIMOBILIARIAPBJP, E-mail: junior_pbjp@hotmail.com</b>, declaro para os devidos fins que foi recebido da Senhora: <?php $nome = $_POST['nome']; echo $nome; ?>, CPF: <?php $cpf = $_POST['cpf']; echo $cpf; ?>, o valor de R$<?php $valor = $_POST['valor']; echo $valor; ?> , referente a fiança do imóvel situado a <?php $localizacao = $_POST['localizacao']; echo $localizacao; ?></p><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
